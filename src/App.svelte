...
<div class="page" class:show={page === 'home'}>
	...
	<p>
		Sed eleifend eleifend risus, quis sagittis est egestas id. Suspendisse
	...
	<p>
		Pellentesque egestas sapien a eleifend viverra. Vestibulum ultrices
...
<div class="page" class:show={page === 'about'}>
	<h1>ABOUT</h1>
	<p>
		Duis massa augue, imperdiet ut sem ac, cursus sagittis nulla. Donec quis
	...
	<p>
		Maecenas non nisi metus. Curabitur a augue ultrices, efficitur lorem id,
...
<div class="page" class:show={page === 'products'}>
	<h1>PRODUCTS</h1>
	<p>
		Nam a nunc velit. Duis condimentum turpis eget elit volutpat varius. Sed
...
<div class="page" class:show={page === 'contact'}>
	...
	<p style="padding-left: 20px; text-indent: 0">
		...
		<br />
		<span><b>EMAIL:</b> berkin_akkaya@hotmail.com</span>
	</p>
	<p>
		In blandit interdum leo, ac accumsan elit ornare vitae. Integer
	...
	<p>
		Nulla ut dui neque. Aliquam bibendum, est quis mattis hendrerit, neque
